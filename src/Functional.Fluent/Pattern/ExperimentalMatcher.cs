...
{
    public class ExperimentalMatcher<TV, TU> : IEnumerable<TU>
    {
        ...
        public ExperimentalMatcher()
        {
            ContextValue = null;
        }

        public ExperimentalMatcher(MonadicValue<TV> contextValue )
        {
        ...
        public ExperimentalMatcher<TV, TU> With(Expression<Func<TV, bool>> predicate, Expression<Func<TV, TU>> func)
        {
            Add(predicate, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(Expression<Func<TV, bool>> predicate, TU resultValue)
        {
            Add(predicate, MakeConstantResultExpression(resultValue));
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, Expression<Func<TV, TU>> func)
        {
            Add(value, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TU resultValue)
        {
            Add(value, MakeConstantResultExpression(resultValue));
            return this;
        }
        
        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, Expression<Func<TV, TU>> func)
        {
            Add(new[] { value, value2 }, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TU resultValue)
        {
            Add(new[] { value, value2 }, MakeConstantResultExpression(resultValue));
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TV value3, Expression<Func<TV, TU>> func)
        {
            Add(new[] { value, value2, value3 }, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TV value3, TU resultValue)
        {
            Add(new[] { value, value2, value3 }, MakeConstantResultExpression(resultValue));
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TV value3, TV value4, Expression<Func<TV, TU>> func)
        {
            Add(new[] { value, value2, value3, value4 }, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TV value3, TV value4, TU resultValue)
        {
            Add(new[] { value, value2, value3, value4 }, MakeConstantResultExpression(resultValue));
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TV value3, TV value4, TV value5, Expression<Func<TV, TU>> func)
        {
            Add(new[] { value, value2, value3, value4, value5 }, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(TV value, TV value2, TV value3, TV value4, TV value5, TU resultValue)
        {
            Add(new[] { value, value2, value3, value4, value5 }, MakeConstantResultExpression(resultValue));
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(IEnumerable<TV>values , Expression<Func<TV, TU>> func)
        {
            Add(values, func);
            return this;
        }

        public ExperimentalMatcher<TV, TU> With(IEnumerable<TV> values, TU resultValue)
        {
        ...
        public ExperimentalMatcher<TV, TU> Null(Expression<Func<TV, TU>> func)
        {
            Add(x => x == null, func, false);
            return this;
        }

        public ExperimentalMatcher<TV, TU> Null(TU resultValue)
        {
            Add(x => x == null, MakeConstantResultExpression(resultValue), false);
            return this;
        }

        public ExperimentalMatcher<TV, TU> Else(Expression<Func<TV, TU>> func)
        {
            Add(x => true, func, false);
            return this;
        }
        
        public ExperimentalMatcher<TV, TU> Else(TU resultValue)
        {
