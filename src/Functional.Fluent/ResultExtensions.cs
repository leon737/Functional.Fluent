...
namespace Functional.Fluent
{
    public static class ResultExtensions
    {
        ...
        public static Result<TV> Success<TV>(this Result result, Func<Result<TV>> f) =>
        ...
        public static Result Success<TV>(this Result result, Action f) =>
