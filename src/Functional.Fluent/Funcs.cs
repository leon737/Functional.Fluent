...
namespace Functional.Fluent
{
    public static class Funcs
    {
        ...
        public static Func<Void> ToVoid(Action v) => () => { v(); return new Void(); };

        public static Func<T1, Void> ToVoid<T1>(Action<T1> v) => p1 => { v(p1); return new Void(); };

        public static Func<T1, T2, Void> ToVoid<T1, T2>(Action<T1, T2> v) => (p1, p2) => { v(p1, p2); return new Void(); };

        public static Func<T1, T2, T3, Void> ToVoid<T1, T2, T3>(Action<T1, T2, T3> v) => (p1, p2, p3) => { v(p1, p2, p3); return new Void(); };

        public static Func<T1, T2, T3, T4, Void> ToVoid<T1, T2, T3, T4>(Action<T1, T2, T3, T4> v) => (p1, p2, p3, p4) => { v(p1, p2, p3, p4); return new Void(); };

        public static Func<T1, T2, T3, T4, T5, Void> ToVoid<T1, T2, T3, T4, T5>(Action<T1, T2, T3, T4, T5> v) => (p1, p2, p3, p4, p5) => { v(p1, p2, p3, p4, p5); return new Void(); };
    }
}
